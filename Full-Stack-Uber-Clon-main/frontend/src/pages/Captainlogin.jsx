  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      <div>
        ...
        <p className='text-center'>¿Quieres ser conductor? <Link to='/captain-signup' className='text-blue-600 hover:underline'>Regístrate como Conductor</Link></p>
      </div>

      <div>
        <Link
          to='/login'
          className='bg-[#d5622d] hover:bg-[#c15626] flex items-center justify-center text-white font-semibold mb-5 rounded-lg px-4 py-2 w-full text-lg transition-colors'
        >
